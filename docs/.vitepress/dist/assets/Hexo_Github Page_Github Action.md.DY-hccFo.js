import{_ as s,c as a,o as n,a3 as e}from"./chunks/framework.BnucP8RU.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Hexo+Github Page+Github Action.md","filePath":"Hexo+Github Page+Github Action.md"}'),p={name:"Hexo+Github Page+Github Action.md"},i=e(`<h2 id="本地hexo" tabindex="-1">本地Hexo <a class="header-anchor" href="#本地hexo" aria-label="Permalink to &quot;本地Hexo&quot;">​</a></h2><ol><li>安装Node.js</li><li>安装Git</li><li>在本地新建文件夹 blog_hexo</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>cd D:\\blog_hexo&gt;</span></span>
